  ...
  <div className="min-h-screen flex flex-col">
    ...
    <main className="flex-1 container py-12 max-w-3xl">
      ...
      <div className="prose prose-sm text-foreground/85 space-y-4">
        ...
        <p>These commissions help us maintain the site and continue providing free PDF book downloads. We only recommend books we genuinely believe provide value.</p>
