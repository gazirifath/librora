      ...
      <main className="flex-1 container py-12 max-w-3xl">
        {isLoading ? (
          ...
          <>
            ...
            <div
              className="prose prose-sm text-foreground/85 space-y-4 prose-headings:font-heading prose-headings:text-foreground prose-h2:text-xl prose-h2:font-semibold prose-h2:mt-6 prose-ul:list-disc prose-ul:pl-6 prose-li:space-y-1 prose-strong:font-semibold"
